...
CA_PASSWORD = 0# A compléter
SERVER_PASSWORD = 0# A compléter
...
certificate_authority = CertificateAuthority#(à compléter) 
...
signed_certificate = 0# A compléter regardez ca/core.py et server/core.py
